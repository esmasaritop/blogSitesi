        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
              ...
              <span class="app-brand-logo demo">
                ...
                >
                  ...
                  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <a href="{{ route('films_index') }}" class="navbar-brand logo" style="font-size: 24px;">
                        Admin Panel
                    </a>
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item active">
                    <a href="{{route('films_index')}}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="Analytics">Filmler</div>
                    </a>
                </li>
                ...
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <div data-i18n="Authentications">Yönetim</div>
                    </a>
                    <ul class="menu-sub">
...
<!-- Page JS -->
<script src="{{asset('adminPanel/assets/js/dashboards-analytics.jss')}}"></script>
